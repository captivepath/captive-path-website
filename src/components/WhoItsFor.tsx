...
export function WhoItsFor() {
  ...
  return (
    <section ref={ref} className="py-22 md:py-30 bg-stone-100/50 border-y border-stone-200">
      <div className="max-w-6xl mx-auto px-6 md:px-10">
        ...
        <div className="reveal-stagger grid grid-cols-1 md:grid-cols-3 gap-6">
          {audiences.map((item) => (
            <div
              key={item.label}
              className="reveal bg-stone-50 border border-stone-200 rounded-sm p-8 md:p-10"
            >
              <p className="text-xs font-semibold tracking-widest uppercase text-teal-800 mb-4">
                {item.label}
              </p>
