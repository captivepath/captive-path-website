...
export function CredibilityStrip() {
  ...
  return (
    <section ref={ref} className="border-y border-stone-200 bg-stone-100/60">
      <div className="max-w-6xl mx-auto px-6 md:px-10 py-14 md:py-18">
        <div className="reveal">
          <p className="font-display text-2xl md:text-3xl text-graphite-800 italic leading-snug max-w-3xl">
